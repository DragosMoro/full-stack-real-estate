  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useState9 = React19.useState, useEffect10 = React19.useEffect, useLayoutEffect = React19.useLayoutEffect, useDebugValue = React19.useDebugValue;
...
var ReactQueryDevtoolsPanel = React18.forwardRef(function ReactQueryDevtoolsPanel2(props, ref) {
  ...
  }, "Clear"), React18.createElement(Button, {
    type: "button",
    onClick: () => {
      if (isMockOffline) {
...
var ActiveQuery = ({
  ...
  return React18.createElement(ActiveQueryPanel, null, React18.createElement("div", {
  ...
  }, "Remove"), " ", React18.createElement(Button, {
    type: "button",
    onClick: () => {
  ...
  }, activeQuery.state.status === "loading" ? "Restore" : "Trigger", " ", "loading"), " ", errorTypes.length === 0 || activeQuery.state.status === "error" ? React18.createElement(Button, {
    type: "button",
    onClick: () => {
  ...
  }, activeQuery.state.status === "error" ? "Restore" : "Trigger", " error") : React18.createElement("label", null, "Trigger error:", React18.createElement(Select, {
    ...
    key: "",
    value: ""
  }), errorTypes.map((errorType) => React18.createElement("option", {
    key: errorType.name,
    value: errorType.name
  }, errorType.name))))), React18.createElement("div", {
    style: {
      background: defaultTheme.backgroundAlt,
      padding: ".5em",
      position: "sticky",
